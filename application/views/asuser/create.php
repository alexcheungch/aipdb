    ...
    <article class="cl pd-20">
        <form action="<?php echo base_url('asuser/save')?>" method="POST" id="JobMtn_form" class="form form-horizontal">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UMenu" id="UMenu" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">MMenu:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="MMenu" id="MMenu" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">QMenu:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="QMenu" id="QMenu" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">UClient:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UClient" id="UClient" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">UJob:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UJob" id="UJob" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">UJobProg:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UJobProg" id="UJobProg" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">UAlloc:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UAlloc" id="UAlloc" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">QClient:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="QClient" id="QClient" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">QJob:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="QJob" id="QJob" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">QJobProg:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="QJobProg" id="QJobProg" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">QAlloc:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="QAlloc" id="QAlloc" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">UJobProgSuperUser:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UJobProgSuperUser" id="UJobProgSuperUser" value="0">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-2 col-sm-2">UAllocSuperUser:</label>
                <div class="formControls col-xs-3 col-sm-3">
                    <input type="text" class="input-text" name="UAllocSuperUser" id="UAllocSuperUser" value="0">
                </div>
            </div>
            <div class="row cl">
